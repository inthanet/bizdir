...
//************ Category Name Already Exist Check Starts ***************
        ...
        $category_name_exist_check = mysqli_query($conn, "SELECT * FROM " . COUNTRY_PREFIX . "job_categories  WHERE category_name='" . $category_name . "' AND category_id != $category_id ");
...
//************ Category Name Already Exist Check Ends ***************
        ...
        function checkJobbbCategorySlug($link, $category_id, $counter = 1)
        {
            ...
            $newLink = $link;
            do {
                $checkLink = mysqli_query($conn, "SELECT category_id FROM " . COUNTRY_PREFIX . "job_categories WHERE category_slug = '$newLink' AND category_id != '$category_id'");
        ...
        $sql = mysqli_query($conn, "UPDATE  " . COUNTRY_PREFIX . "job_categories SET category_name='" . $category_name . "', category_status='" . $category_status . "'
