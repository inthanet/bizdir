...
//************ Category Name Already Exist Check Starts ***************
        ...
        $category_name_exist_check = mysqli_query($conn, "SELECT * FROM " . COUNTRY_PREFIX . "news_categories  WHERE category_name='" . $category_name . "' ");
        ...
        $counter = 1;
        $checkLink = mysqli_query($conn, "SELECT category_id FROM " . COUNTRY_PREFIX . "news_categories WHERE category_slug = '$category_name1'");
        ...
        $sql = mysqli_query($conn, "INSERT INTO  " . COUNTRY_PREFIX . "news_categories (category_name,category_status,category_image
...
VALUES ('$category_name','$category_status','$category_image'
        ...
        $upqry = mysqli_query($conn, "UPDATE " . COUNTRY_PREFIX . "news_categories
