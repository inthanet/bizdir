...
//************ Category Name Already Exist Check Starts ***************
        ...
        $sub_category_name_exist_check = mysqli_query($conn, "SELECT * FROM " . COUNTRY_PREFIX . "job_sub_categories  WHERE sub_category_name='" . $sub_category_name . "' AND sub_category_id != $sub_category_id ");
        ...
        if (mysqli_num_rows($sub_category_name_exist_check) > 0) {
            ...
            header('Location: admin-job-sub-category-edit.php?row=' . $sub_category_id);
            exit;
...
//************ Category Name Already Exist Check Ends ***************
        ...
        function checkJobbbSubCategorySlug($link, $sub_category_id, $counter = 1)
        {
            global $conn;
            $newLink = $link;
            do {
                $checkLink = mysqli_query($conn, "SELECT sub_category_id FROM " . COUNTRY_PREFIX . "job_sub_categories WHERE sub_category_slug = '$newLink' AND sub_category_id != '$sub_category_id'");
        ...
        $sub_category_slug = checkJobbbSubCategorySlug($sub_category_slug1, $sub_category_id);


        $sql = mysqli_query($conn, "UPDATE  " . COUNTRY_PREFIX . "job_sub_categories SET sub_category_name='" . $sub_category_name . "', sub_category_status='" . $sub_category_status . "'
