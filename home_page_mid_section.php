...
<!-- START -->
<?php if(FEATURED_SERVICES == 'on'){ ?>
    <section>
        <div class='hom-mpop-ser'>
            <div class='container'>
                <div class='hom-mpop-main'>
                    <div class='home-tit'>
                        <h2><span><?php echo $BIZBOOK[ 'HOM-BEST-TIT' ];?></span></h2>
                        ...
                        <ul class='multiple-items1'>
                            ...
                            foreach (getAllFeaturedListing() as $row) {
                                ...
                                <div class='testmo hom4-prop-box'>
                                    ...
                                    <?php } ?>
                                    <span>
                                        <a href='#'><?php echo $popular_business_category_sql_row[ 'category_name' ];?></a>
                                    </span>
                                </div>
...
<!-- START -->
<?php if(WHAT_YOU_ARE_LOOKING_FOR == 'on'){ ?>
    <section>
        <div class='hom-mpop-ser'>
            <div class='container'>
                            ...
                            <form name='home_enquiry_form' id='home_enquiry_form' method='post' enctype='multipart/form-data'>
                                ...
                                <div class='form-group'>
                                    <select name='enquiry_category' id='enquiry_category' class='form-control'>
                                        ...
                                        <?php foreach (getAllCategories() as $categories_row) { ?>
                                                <option value="<?php echo $categories_row['category_id']; ?>">
...
<!-- START -->
<?php if(TOP_SERVICE_PROVIDER_CITY == 'on'){ ?>
    <section>
        <div class='str str-full'>
            <div class='container'>
                <div class='row'>
                    <div class='home-tit'>
                        <h2> 
                            <span><?php echo $BIZBOOK['HOM-TOPSER-TIT']; ?></span> 
                            <?php echo $BIZBOOK['HOM-TOPSER-TIT1']; ?>
                        </h2>
                        ...
                        foreach (getAllTopServiceProviders() as $row) {
                            ...
                            <div class='col-md-4'>
                                <div class='hot-page2-hom-pre-head'>
                                    <h4>
                                        <?php echo $all_texts_row['branding_title']; ?>
                                        <span><?php echo $top_service_category_sql_row['category_name']; ?></span>
                                            </h4>
                                        </div>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <div class='hot-page2-hom-pre-1'>
                                                        <img src="<?php if ($top_listing_row['profile_image'] != null || !empty($top_listing_row['profile_image'])) {
                                                    ...
                                                    <?php } ?>
                                                    <a href="<?php echo $LISTING_URL . urlModifier($top_listing_row['listing_slug']); ?>" class='fclick'></a>
                                                </li>
                                            <?php
                                                }
                                                ?>
    ...
    <div id="demo" class="carousel slide cate-sli caro-home" data-ride="carousel">
        ...
        <div class="row">
            ...
            <div class="carousel-inner">
                ...
                <img src="images/slider/<?php echo $slider_row['slider_photo']; ?>" alt="Los Angeles" width="1100" height="500" loading="lazy" />
        ...
        <div class='container'>
            <div class='row'>
                <div class='plac-det-tit-inn'>
                    <h2><?php echo $BIZBOOK[ 'EXPL-MORE-FEA' ];
                ?></h2>
                </div>
                            ...
                            <div class='plac-hom-box'>
                                <div class='plac-hom-box-im'>
                                    <img src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                        data-src="images/user/<?php echo $footer_row['job_default_image']; ?>"
                                        class='b-lazy' alt=''>
                                    <div class='inn-text'>
                                        <h4><?php echo $BIZBOOK[ 'HOM-MODU-TIT-JOB' ];?></h4>
                                        <a href='jobs/'><?php echo $BIZBOOK[ 'PROFILE-QUICK-ACCESS-SPAN-3' ];?> 
                    ...
                    ?>
                        ...
                        <li>
                            <div class='plac-hom-box'>
                                <div class='plac-hom-box-im'>
                                    <img src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                        data-src="images/user/<?php echo $footer_row['product_default_image']; ?>"
                                        class='b-lazy' alt=''>
                                    <div class='inn-text'>
                                        <h4><?php echo $BIZBOOK[ 'HOM-MODU-TIT-PROD' ];?></h4>
                                        <a href='all-products'><?php echo $BIZBOOK[ 'HOM-MODU-START-SELLING' ];?> 
                                          <i class='material-icons'>arrow_forward</i>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <li>
                            <div class='plac-hom-box'>
                                <div class='plac-hom-box-im'>
                                    <img src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                        data-src="images/user/<?php echo $footer_row['coupon_default_image']; ?>"
                                        class='b-lazy' alt=''>
                                    <div class='inn-text'>
                                        <h4><?php echo $BIZBOOK[ 'HOM-MODU-TIT-DEAL' ];?></h4>
                                        <a href='coupons'><?php echo $BIZBOOK[ 'COUPON' ];?> 
                                         <i class='material-icons'>arrow_forward</i>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <li>
                            <div class='plac-hom-box'>
                                <div class='plac-hom-box-im'>
                                    <img src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                        data-src="images/user/<?php echo $footer_row['travel_default_image']; ?>"
                                        class='b-lazy' alt=''>
                                    <div class='inn-text'>
                                        <h4><?php echo $BIZBOOK[ 'HOM-MODU-TIT-TRAVEL' ];?></h4>
                                        <a href='places/'><?php echo $BIZBOOK[ 'PLACE-MENU' ];?> 
                                         <i class='material-icons'>arrow_forward</i>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <li>
                            <div class='plac-hom-box'>
                                <div class='plac-hom-box-im'>
                                    <img src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                        data-src="images/user/<?php echo $footer_row['expert_default_image']; ?>"
                                        class='b-lazy' alt=''>
                                    <div class='inn-text'>
                                        <h4><?php echo $BIZBOOK[ 'HOM-MODU-TIT-EXP' ];?></h4>
                                        <a href='service-experts/'>
                                            <?php echo $BIZBOOK[ 'HOM-MODU-BOOK-EXPERT-NOW' ];?>
                                             <i class='material-icons'>arrow_forward</i>
                                            </a>
                                    </div>
                                </div>
                        ...
                        <li>
                            <div class='plac-hom-box'>
                                <div class='plac-hom-box-im'>
                                    <img src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                        data-src="images/user/<?php echo $footer_row['news_default_image']; ?>"
                                        class='b-lazy' alt=''>
                                    <div class='inn-text'>
                                        <h4><?php echo $BIZBOOK[ 'HOM-MODU-TIT-NEWS' ];?></h4>
                                        <a href='news/'><?php echo $BIZBOOK[ 'NEWS-HOMEPAGE-BANNER-H1-TEXT-2' ];?> 
                                         <i class='material-icons'>arrow_forward</i>
                                        </a>
                                    </div>
                                </div>
            ...
            <div>
                <ul>
                    ...
                    <li>
                        <div class='pri-box'>
                            <div class='c2'>
                                <h4><?php echo $plan_type_row[ 'plan_type_name' ];?> 
                                 <?php echo $BIZBOOK[ 'PLAN' ];?>
                                </h4>
                            ...
                            <div class='c3'>
                                <h2>
                                    <span></span>
                                    <?php if ( $plan_type_row[ 'plan_type_price' ] == 0 ) { echo $BIZBOOK[ 'FREE' ];
                                          } else { if ( $footer_row[ 'currency_symbol_pos' ] == 1 ) { echo $footer_row[ 'currency_symbol' ];}
                            ...
                            <div class='c5'>
                                <a href="<?php if (isset($_SESSION['user_id'])) {
                                            ...
                                            echo "login";
                                        } ?>" class='cta1'><?php echo $BIZBOOK[ 'PRICING_GET_START' ];?>
                                </a>
                                <a href='pricing-details' class='cta2' target='_blank'>
                                    <?php echo $BIZBOOK[ 'HOM-VI-KNOW-MORE' ];?>
                                </a>
                            </div>
                        </div>
                    </li>
        ...
        <div class="str count">
            <div class="container">
                <div class="row">
                    <div class="home-tit">
                        <h2>
                            <span><?php echo $BIZBOOK[ 'HOM-EVE-TIT' ];?></span>
                            <?php echo $BIZBOOK[ 'HOM-EVE-TIT1' ];?>
                        </h2>
                        <p><?php echo $BIZBOOK[ 'HOM-EVE-SUB-TIT' ];?></p>
                    </div>
                    <div class="hom-event">
                        <div class="hom-eve-com hom-eve-lhs">
                            <?php foreach ( getAllTopEventsLimit( 1, 2 ) as $topeventrow_1 ) {
                                //To Fetch Top Events First Two Rows using position Id
                                    ...
                                    <div class="eve-box">
                                        <div>
                                            <a href="<?php echo $EVENT_URL . urlModifier($event_sql_row['event_slug']); ?>">
                                                ...
                                                <span>
                                                    <?php echo dateMonthFormatconverter( $event_sql_row[ 'event_start_date' ] );?>
                                                    <b><?php echo dateDayFormatconverter( $event_sql_row[ 'event_start_date' ] );?></b>
                                                </span>
                                            </a>
                                        </div>
                                        <div>
                                            <h4>
                                                <a href="<?php echo $EVENT_URL . urlModifier($event_sql_row['event_slug']); ?>">
                                                    <?php echo $event_sql_row[ 'event_name' ];?>
                                                </a>
                                            </h4>
                                            <span class="addr">
                                                <?php echo $event_sql_row[ 'event_address' ];?>
                                            </span>
                                            <span class="pho">
                                                <?php echo $event_sql_row[ 'event_mobile' ];?>
                                            </span>
                                        </div>
                                        <div>
                                            <div class="auth">
                                                <img src = "images/user/<?php if (($user_details_row['profile_image'] == NULL) || empty($user_details_row['profile_image'])) { 
                                                        echo "1.jpg";
                                                    } else {
                                                        echo $user_details_row['profile_image'];
                                                    } ?>" alt = ''>
                                                <b><?php echo $BIZBOOK[ 'EVENT_HOSTED_BY' ];?></b>
                                                <br />
                                                <h4>
                                                    <?php echo $user_details_row[ 'first_name' ];?>
                                                </h4>
                                                <a target="_blank" href="<?php echo $PROFILE_URL . urlModifier($user_details_row['user_slug']); ?>" class="fclick"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="hom-eve-lhs-2 col-md-4">
                                <ul>
                                    <?php
                                        foreach ( getAllTopEventsLimit( 3, 6 ) as $topeventrow_2 ) {
                                            //To Fetch Top Events First Two Rows using position Id
                                    ...
                                    <li>
                                        <div class="eve-box-list">
                                            <img src="images/events/<?php echo $event_sql_row['event_image']; ?>" alt="" />
                                            <h4 title="<?php echo $event_sql_row['event_name']; ?>">
                                                <?php echo $event_sql_row[ 'event_name' ];?>
                                            </h4>
                    ...
                    <div class="how-wrks">
                        <div class="home-tit">
                            <h2>
                                <span><?php echo $BIZBOOK[ 'HOM-HOW-TIT' ];?></span>
                            </h2>
                    ...
                    <?php if ( $footer_row[ 'admin_mobile_app_feature' ] == 1 ) {?>
                        <div class="mob-app">
                            ...
                            <div class="rhs">
                                <h2>
                                    <?php echo $BIZBOOK[ 'HOM-APP-TIT' ];?><span>
                                    <?php echo $BIZBOOK[ 'HOM-APP-TIT-SUB' ];?></span>
                                </h2>
                                <ul>
                                    <li>
                                        <?php echo $BIZBOOK[ 'HOM-APP-PO-1' ];?>
                                    </li>
                                    <li>
                                        <?php echo $BIZBOOK[ 'HOM-APP-PO-2' ];?>
                                    </li>
                                    <li>
                                        <?php echo $BIZBOOK[ 'HOM-APP-PO-3' ];?>
                                    </li>
                                    <li>
                                        <?php echo $BIZBOOK[ 'HOM-APP-PO-4' ];?>
                                    </li>
                                </ul>
                                <span>
                                    <?php echo $BIZBOOK[ 'HOM-APP-SEND' ];?>
                                </span>
...
<section>
    <div class='plac-hom-bd'>
        <div class='container'>
            <div class='row'>
                <div class='plac-det-tit-inn'>
                    <h2><span><?php echo $BIZBOOK[ 'HOM-POP-TIT' ];?></span> 
                      <?php echo $BIZBOOK[ 'HOM-POP-TIT1' ];?>
                    </h2>
                </div>
                        ...
                        <li>
                            <div class='plac-hom-box'>
                                <div class='plac-hom-box-im'>
                                    <img src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                        class='b-lazy'
                                        data-src="images/services/<?php echo $category_sql_row['category_image']; ?>"
                                        alt=''>
                                    <h4><?php echo $category_sql_row[ 'category_name' ];?></h4>
                                </div>
                                <div class='plac-hom-box-txt'>
                                    <span>Listing:
                                        <?php echo AddingZero_BeforeNumber( getCountCategoryListing( $category_sql_row[ 'category_id' ] ) );?></span>
...
<section>
    <div class='plac-hom-bd plac-deta-sec plac-deta-sec-com'>
        <div class='container'>
            <div class='row'>
                <div class='plac-det-tit-inn'>
                    <h2><span><?php echo $BIZBOOK[ 'HOM-BAN-TIT-CAT' ];
                                                                    ?></span></h2>
                </div>
                <div class='plac-hom-all-pla'>
                    <ul class='travel-sliser'>
                        ...
                        <li>
                            <div class='plac-hom-box'>
                                <div class='plac-hom-box-im'>
                                    <img src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                        class='b-lazy'
                                        data-src="<?php echo $slash; ?>service-experts/images/services/<?php echo $expert_categories_row['category_image']; ?>"
                                        alt=''>
                                    <h4><?php echo $category_name;
                                                                        ?></h4>
                                </div>
                                <div class='plac-hom-box-txt'>
                                    <span><?php echo $BIZBOOK[ 'SERVICE-EXPERTS-EXPERTS' ];
                                                                        ?><?php echo $total_experts_category;
                                                                        ?></span>
                                    <span>More details</span>
                                </div>
                    ...
                    <ul>
                        <li>
                            <div class='plac-hom-box'>
                                <div class='plac-hom-box-im'>
                                    <img src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                        class='b-lazy' data-src='images/home2-hand.jpg' alt=''>
                                    <div class='inn-text'>
                                        <h4>Start finding your dream job now</h4>
                                        <a href='jobs/'>Start finding <i class='material-icons'>arrow_forward</i></a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class='plac-hom-box'>
                                <div class='plac-hom-box-im'>
                                    <img src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                        class='b-lazy' data-src='images/products/start-selling.jpg' alt=''>
                                    <div class='inn-text'>
                        ...
                        <li>
                            <div class='plac-hom-box'>
                                <div class='plac-hom-box-im'>
                                    <img src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                        class='b-lazy' data-src='images/coupon-deals.jpg' alt=''>
                                    <div class='inn-text'>
        ...
        <div class='container'>
            <div class='row'>
                <div class='plac-hom-tit plac-hom-tit-ic-ser'>
                    <h2>
                        <span><?php echo $BIZBOOK[ 'HOM-BEST-TIT' ];
                                                                    ?></span> <?php echo $BIZBOOK[ 'HOM-BEST-TIT1' ];
                                                                    ?>
                    </h2>
                    <p><?php echo $BIZBOOK[ 'HOM-BEST-SUB-TIT' ];
                                                                    ?></p>
                </div>
                <div class='plac-hom-all-pla'>
                    <ul class='travel-sliser'>
                        ...
                        <li>
                            <div class='plac-hom-box'>
                                <div class='plac-hom-box-im'>
                                    <img src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                        class='b-lazy' data-src="<?php if ($listing_sql_row['profile_image'] != NULL || !empty($listing_sql_row['profile_image'])) {
                                                    echo "images/listings/" . $listing_sql_row['profile_image'];
                                                } else {
                                                    echo "images/listings/" . $footer_row['listing_default_image'];
                                                } ?>" alt=''>
                                    <h4><?php echo $listing_sql_row[ 'listing_name' ];
                                                                        ?></h4>
                                    <span class='plac-det-cate'><?php echo $popular_business_category_sql_row[ 'category_name' ];
                                                                        ?></span>
                                </div>
                                <div class='plac-hom-box-txt'>
        ...
        <div class='container'>
            <div class='row'>
                <div class='plac-hom-tit plac-hom-tit-ic-eve'>
                    <h2><span><?php echo $BIZBOOK[ 'HOM-EVE-TIT' ];
                                                                        ?></span> <?php echo $BIZBOOK[ 'HOM-EVE-TIT1' ];
                                                                        ?>
                    </h2>
                    <p><?php echo $BIZBOOK[ 'HOM-EVE-SUB-TIT' ];
                                                                        ?></p>
                </div>
                <div class='plac-hom-all-pla plac-det-eve'>
                    <ul class='travel-sliser'>
                        ...
                        foreach ( getAllTopEvents() as $topeventrow_1 ) {
                            //To Fetch Top Events First Two Rows using position Id
                        ...
                        <li>
                            <div class='plac-hom-box'>
                                <div class='plac-hom-box-im'>
                                    <img src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                        class='b-lazy'
                                        data-src="images/events/<?php echo $event_sql_row['event_image']; ?>" alt=''>
                                    <h4><?php echo $event_sql_row[ 'event_name' ];
                                                                            ?></h4>
                                    <span class='plac-det-cate'><?php echo dateMonthFormatconverter( $event_sql_row[ 'event_start_date' ] );
                                                                            ?><?php echo dateDayFormatconverter( $event_sql_row[ 'event_start_date' ] );
                                                                            ?></span>
                                </div>
                                <a href="<?php echo $EVENT_URL . urlModifier($event_sql_row['event_slug']); ?>"
                                    class='fclick'></a>
            ...
            <div class='row'>
                <div class='plac-hom-tit plac-hom-tit-ic-nws'>
                    <h2><?php echo $BIZBOOK[ 'NEWS-HOMEPAGE-BANNER-H1-TEXT-2' ];
                                                                        ?>
                        <b><?php echo $place_row[ 'place_name' ];
                                                                        ?></b>
                    </h2>
                    <p><?php echo $BIZBOOK[ 'NEWS-HOMEPAGE-BANNER-P-TEXT' ];
                                                                        ?>
                        <b><?php echo $BIZBOOK[ 'PLACE-NEWS-B' ];
                                                                        ?></b>
                    </p>
                </div>
                <div class='plac-hom-all-pla plac-det-eve'>
                        ...
                        <li>
                            <div class='plac-hom-box'>
                                <div class='plac-hom-box-im'>
                                    ...
                                    <h4><?php echo stripslashes( $home_page_slider_news_sql_row[ 'news_title' ] );
                                                                            ?></h4>
                                    <span class='plac-det-cate'><?php echo $home_page_slider_category_name;
                                                                            ?></span>
                                </div>
...
<section>
    <div class='plac-hom-bd'>
        <div class='container'>
            <div class='row'>
                <div class='plac-det-tit-inn'>
                    <h2><?php echo $BIZBOOK[ 'PLACE-MENU' ];
                                                                            ?></h2>
                </div>
                <div class='plac-hom-all-pla'>
                    <ul class='travel-sliser'>
                        ...
                        <li>
                            <div class='plac-hom-box'>
                                <div class='plac-hom-box-im'>
                                    <img src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                        class='b-lazy'
                                        data-src="<?php echo $slash; ?>places/images/places/<?php echo explode(',', $placerow['place_gallery_image'])[0]; ?>"
                                        alt=''>
                                    <h4><?php echo stripslashes( $placerow[ 'place_name' ] );
                                                                                ?></h4>
                                </div>
                                <div class='plac-hom-box-txt'>
                                    <span><?php echo $category_row[ 'category_name' ];
                                                                                ?></span>
                                    <span><?php echo $BIZBOOK[ 'PLACE-MORE-DETAILS' ];
                                                                                ?></span>
                                </div>
    ...
    <div>
        <div class='container'>
            <div class='row'>
                ...
                <div class='home-tit'>
                    <h2><span><?php echo $BIZBOOK[ 'HOM-POP-TIT' ];
                                                                            ?></span> <?php echo $BIZBOOK[ 'HOM-POP-TIT1' ];
                                                                            ?>
                    </h2>
                    <p><?php echo $BIZBOOK[ 'HOM-POP-SUB-TIT' ];
                                                                            ?></p>
                </div>
                <div class='land-pack'>
                    <ul>
                        ...
                        <li>
                            <div class='land-pack-grid'>
                                <div class='land-pack-grid-img'>
                                    <img src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                        class='b-lazy'
                                        data-src="<?php echo $webpage_full_link; ?>images/services/<?php echo $category_sql_row['category_image']; ?>"
                                        alt=''>
                                </div>
                                <div class='land-pack-grid-text'>
                                    <h4><?php echo $category_sql_row[ 'category_name' ];
                                        ...
                                        <span class='dir-ho-cat'><?php echo $BIZBOOK[ 'LISTINGS' ];
                                                                                ?><?php echo AddingZero_BeforeNumber( getCountCategoryListing( $category_sql_row[ 'category_id' ] ) );
                                                                                ?></span>
                                    </h4>
                                </div>
                                <a href="<?php echo $ALL_LISTING_URL . urlModifier($category_sql_row['category_slug']); ?>"
                                    class='land-pack-grid-btn'><?php echo $BIZBOOK[ 'VIEW_ALL_LISTINGS' ];
                                                                                ?></a>
                            </div>
                        </li>
                        <?php
                ...
                <div class='hom2-cus-sli'>
                    <ul class='multiple-items1'>
                        ...
                        <li>
                            <div class='testmo hom4-prop-box'>
                                <img src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                    class='b-lazy' data-src="<?php echo $webpage_full_link; ?><?php if ($listing_sql_row['profile_image'] != NULL || !empty($listing_sql_row['profile_image'])) {
                                                echo "images/listings/" . $listing_sql_row['profile_image'];
                                            } else {
                                                echo "images/listings/" . $footer_row['listing_default_image'];
                                            } ?>" alt=''>
                                <div>
                                    <h4>
                                        <a
                                            href="<?php echo $LISTING_URL . urlModifier($listing_sql_row['listing_slug']); ?>"><?php echo $listing_sql_row[ 'listing_name' ];
                                                                                ?></a>
                                    </h4>
                                    <?php if ( $star_rate != 0 ) {
                                                                                    ?>
                                    ...
                                    <?php }
                                                                                    ?>
                                    <span><a href='#'><?php echo $popular_business_category_sql_row[ 'category_name' ];
                                                                                    ?></a></span>
                                </div>
                                <a href="<?php echo $LISTING_URL . urlModifier($listing_sql_row['listing_slug']); ?>"
                                    class='fclick'></a>
...
<section class="<?php if ($footer_row['admin_language'] == 2) {
    ...
    <div class='container'>
        <div class='row'>
            <div class='tit'>
                <h2>
                    <span><?php echo $BIZBOOK[ 'CHOOSE_YOUR_PLAN' ];
                                                                                ?></span>
                </h2>
            </div>
            <div>
                    ...
                    <li>
                        <div class='pri-box'>
                            <div class='c2'>
                                ...
                                <?php if ( $plan_type_row[ 'plan_type_id' ] == 1 ) {
                                                                                        ?>
                                <p><?php echo $BIZBOOK[ 'PRICING_GETTING_STARTED' ];
                                                                                        ?></p>
                                <?php } elseif ( $plan_type_row[ 'plan_type_id' ] == 2 ) {
                                                                                            ?>
                                <p><?php echo $BIZBOOK[ 'PRICING_PERFECT_SMALL_TEAMS' ];
                                                                                            ?></p>
                                <?php } elseif ( $plan_type_row[ 'plan_type_id' ] == 3 ) {
                                                                                                ?>
                                <p><?php echo $BIZBOOK[ 'PRICING_BEST_VALUE_LARGE' ];
                                                                                                ?></p>
                                <?php } else {
                                                                                                    ?>
                                <p><?php echo $BIZBOOK[ 'PRICING_MADE_ENTERPRISES' ];
                                                                                                    ?></p>
                                <?php
                                                                                                }
                                                                                                ?>
                            ...
                            <div class='c3'>
                                ...
                                <?php if ( $plan_type_row[ 'plan_type_id' ] == 1 ) {
                                                                                                    ?>
                                <p><?php echo $BIZBOOK[ 'PRICING_SINGLE_USER' ];
                                                                                                    ?></p>
                                <?php } elseif ( $plan_type_row[ 'plan_type_id' ] == 2 ) {
                                                                                                        ?>
                                <p><?php echo $BIZBOOK[ 'PRICING_STARTUP_BUSINESS' ];
                                                                                                        ?></p>
                                <?php } elseif ( $plan_type_row[ 'plan_type_id' ] == 3 ) {
                                                                                                            ?>
                                <p><?php echo $BIZBOOK[ 'PRICING_MEDIUM_BUSINESS' ];
                                                                                                            ?></p>
                                <?php } else {
                                                                                                                ?>
                                <p><?php echo $BIZBOOK[ 'PRICING_MADE_ENTERPRISES' ];
                                ...
                                <a href="<?php
                                        if (isset($_SESSION['user_id'])) {
                                            ...
                                            echo "login";
                                                                                                            ...
                                                                                                            ?></a>
                                <a href='pricing-details' class='cta2' target='_blank'><?php echo $BIZBOOK[ 'HOM-VI-KNOW-MORE' ];
                                                                                                            ?></a>
                            </div>
                        </div>
                    </li>
                ...
                <div class='news-hban-box'>
                    <div class='im'>
                        <img loading='lazy'
                            ...
                            class='b-lazy'
                            data-src="<?php echo $webpage_full_link; ?>images/events/<?php echo $event_sql_row['event_image']; ?>"
                            alt=''>
                    </div>
                    <div class='txt'>
                        <span class='news-cate'><?php echo dateMonthFormatconverter( $event_sql_row[ 'event_start_date' ] );
                                                                                                            ?><?php echo dateDayFormatconverter( $event_sql_row[ 'event_start_date' ] );
                                                                                                            ?></span>
                        <h2><?php echo $event_sql_row[ 'event_name' ];
                                                                                                            ?></h2>
                        <span class='news-date'><?php echo $BIZBOOK[ 'HOM3-OW-POSTED-ON' ];
                                                                                                            ?>
                            : <?php echo dateFormatconverter( $event_sql_row[ 'event_cdt' ] );
                                                                                                            ?></span>
                    </div>
                    <a href="<?php echo $EVENT_URL . urlModifier($event_sql_row['event_slug']); ?>" class='fclick'></a>
                </div>
...
<section>
    <div class='str hom2-cus'>
        <div class='container'>
            <div class='row'>
                <div class='home-tit'>
                    <h2><span><?php echo $BIZBOOK[ 'HOM3-OW-USER-REVIEW' ];
                                                                                                        ?></span></h2>
                    <p><?php echo $BIZBOOK[ 'HOM3-OW-TIT-SUB' ];
                                                                                                        ?></p>
                </div>
                <div class='hom2-cus-sli'>
                    <ul class='multiple-items'>
                        ...
                        <li>
                            <div class='testmo'>
                                <img src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                    class='b-lazy' data-src="<?php echo $webpage_full_link; ?>images/user/<?php if (($user_details_row['profile_image'] == NULL) || empty($user_details_row['profile_image'])) {
                                                echo "1.jpg";
                                            } else {
                                                echo $user_details_row['profile_image'];
                                            } ?>" alt=''>
                                <h4><?php echo $user_details_row[ 'first_name' ];
                                                                                                            ?></h4>
                                <span><?php echo $BIZBOOK[ 'SERVICE-EXPERT-WRITTEN-REVIEW-TO' ];
                                                                                                            ?> <a
                                        href="<?php echo $LISTING_URL . urlModifier($listing_sql_row['listing_slug']); ?>"><?php echo $listing_sql_row[ 'listing_name' ];
                                                                                                            ?></a></span>
                                ...
                                <?php
                                                                                                            ...
                                                                                                            ?>
                                <p><?php echo $reviewss_row[ 'review_message' ];
                                                                                                            ?></p>
                            </div>
                        </li>
                        <?php
    ...
    <div class='str count'>
        <div class='container'>
            <div class='row'>
                ...
                <div class='how-wrks'>
                    <div class='home-tit'>
                        <h2><span><?php echo $BIZBOOK[ 'HOM-HOW-TIT' ];
                                                                                                        ?></span></h2>
                        <p><?php echo $BIZBOOK[ 'HOM-HOW-SUB-TIT' ];
                                                                                                        ?></p>
                    </div>
                    <div class='how-wrks-inn'>
                        <ul>
                            <li>
                                <div>
                                    ...
                                    <img loading='lazy'
                                        src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                        class='b-lazy' data-src="<?php echo $webpage_full_link; ?>images/icon/how1.png"
                                        alt=''>
                                    <h4><?php echo $BIZBOOK[ 'HOM-HOW-P-TIT-1' ];
                                                                                                        ?></h4>
                                    <p><?php echo $BIZBOOK[ 'HOM-HOW-P-SUB-1' ];
                                                                                                        ?></p>
                                </div>
                            </li>
                            <li>
                                <div>
                                    ...
                                    <img loading='lazy'
                                        src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                        class='b-lazy' data-src="<?php echo $webpage_full_link; ?>images/icon/how2.png"
                                        alt=''>
                                    <h4><?php echo $BIZBOOK[ 'HOM-HOW-P-TIT-2' ];
                                                                                                        ?></h4>
                                    <p><?php echo $BIZBOOK[ 'HOM-HOW-P-SUB-2' ];
                                                                                                        ?></p>
                                </div>
                            </li>
                            <li>
                                <div>
                                    ...
                                    <img loading='lazy'
                                        src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                        class='b-lazy' data-src="<?php echo $webpage_full_link; ?>images/icon/how3.png"
                                        alt=''>
                                    <h4><?php echo $BIZBOOK[ 'HOM-HOW-P-TIT-3' ];
                                                                                                        ?></h4>
                                    <p><?php echo $BIZBOOK[ 'HOM-HOW-P-SUB-3' ];
                                                                                                        ?></p>
                                </div>
                            </li>
                            <li>
                                <div>
                                    ...
                                    <img loading='lazy'
                                        src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                        class='b-lazy' data-src="<?php echo $webpage_full_link; ?>images/icon/how4.png"
                                        alt=''>
                                    <h4><?php echo $BIZBOOK[ 'HOM-HOW-P-TIT-4' ];
                                                                                                        ?></h4>
                                    <p><?php echo $BIZBOOK[ 'HOM-HOW-P-SUB-4' ];
                                                                                                        ?></p>
                                </div>
                            </li>
                        </ul>
                ...
                <div class='mob-app'>
                    <div class='lhs'>
                        <img loading='lazy'
                            src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                            class='b-lazy' data-src="<?php echo $webpage_full_link; ?>images/mobile.png" alt=''>
                    </div>
                    <div class='rhs'>
                        <h2><?php echo $BIZBOOK[ 'HOM-APP-TIT' ];
                                                                                                            ?>
                            <span><?php echo $BIZBOOK[ 'HOM-APP-TIT-SUB' ];
                                                                                                            ?></span>
                        </h2>
                        <ul>
                            <li><?php echo $BIZBOOK[ 'HOM-APP-PO-1' ];
                                                                                                            ?></li>
                            <li><?php echo $BIZBOOK[ 'HOM-APP-PO-2' ];
                                                                                                            ?></li>
                            <li><?php echo $BIZBOOK[ 'HOM-APP-PO-3' ];
                                                                                                            ?></li>
                            <li><?php echo $BIZBOOK[ 'HOM-APP-PO-4' ];
                                                                                                            ?></li>
                        </ul>
                        <span><?php echo $BIZBOOK[ 'HOM-APP-SEND' ];
                                                                                                            ?></span>
                        <form>
                            <ul>
                                <li>
                        ...
                        <a href='#'><img loading='lazy'
                                src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                class='b-lazy' data-src="<?php echo $webpage_full_link; ?>images/android.png" alt=''>
                        </a>
                        <a href='#'><img loading='lazy'
                                src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=='
                                class='b-lazy' data-src="<?php echo $webpage_full_link; ?>images/apple.png" alt=''> </a>
                    </div>
                </div>
                <?php }
                                                                                                            ?>
...
<section>
    <div class='str'>
        <div class='container'>
            <div class='row'>
                <div class='home-tit'>
                    <h2><span><?php echo $BIZBOOK[ 'HOM3-OW-TIT' ];
                                                                                                                ?></span>
                    </h2>
                    <p><?php echo $BIZBOOK[ 'HOM3-OW-TIT-SUB' ];
                                                                                                                ?></p>
                ...
                <div class='hom2-hom-ban-main'>
                    <div class='hom2-hom-ban hom2-hom-ban1'>
                        <h2><?php echo $BIZBOOK[ 'HOM3-OW-LHS-TIT' ];
                                                                                                                ?></h2>
                        <p><?php echo $BIZBOOK[ 'HOM3-OW-LHS-SUB' ];
                                                                                                                ?></p>
                        <a href='pricing-details'><?php echo $BIZBOOK[ 'HOM3-OW-LHS-CTA' ];
                                                                                                                ?></a>
                    </div>
                    <div class='hom2-hom-ban hom2-hom-ban2'>
                        <h2><?php echo $BIZBOOK[ 'HOM3-OW-RHS-TIT' ];
                                                                                                                ?></h2>
                        <p><?php echo $BIZBOOK[ 'HOM3-OW-RHS-SUB' ];
                                                                                                                ?></p>
                        <a href='login?login=register'><?php echo $BIZBOOK[ 'HOM3-OW-RHS-CTA' ];
                                                                                                                ?></a>
                    </div>
                </div>
            </div>
