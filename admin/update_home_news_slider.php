...
//************ News Title Already Exist Check Starts ***************
        ...
        if($news_id_old != $news_id) {
            $listing_name_exist_check = mysqli_query($conn,"SELECT * FROM " . COUNTRY_PREFIX . "news_slider WHERE news_id='" . $news_id . "' ");
...
//************ News Title Already Exist Check Ends ***************
        ...
        $sql = mysqli_query($conn,"UPDATE  " . COUNTRY_PREFIX . "news_slider SET news_id ='" . $news_id . "'
