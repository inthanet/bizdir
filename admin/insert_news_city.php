...
//************ city Name Already Exist Check Starts ***************
        ...
        $city_name_exist_check = mysqli_query($conn, "SELECT * FROM " . COUNTRY_PREFIX . "news_cities  WHERE city_name='" . $city_name . "' ");
...
//************ city Name Already Exist Check Ends ***************
        ...
        $sql = mysqli_query($conn, "INSERT INTO  " . COUNTRY_PREFIX . "news_cities (city_name,city_cdt)
