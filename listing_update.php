...
//****************************    Admin email starts    *************************
            ...
            $admin_sql_fetch = mysqli_query($conn, "SELECT * FROM " . COUNTRY_PREFIX . "mail  WHERE mail_id = 9 "); //admin mail template fetch
...
//****************************    Client email starts    *************************
            ...
            $client_sql_fetch = mysqli_query($conn, "SELECT * FROM " . COUNTRY_PREFIX . "mail  WHERE mail_id = 8 "); //User mail template fetch
